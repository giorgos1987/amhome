...
/*jshint sub:true */
/*global $, Math, calculateDirection, document, google, navigator, onDeviceReady, onGeoError, onGeoSuccess, parseInt, relativePosition, setupMap,  window 38.0403338,23.7588073 */
...
var formLat = "";
var pin = [
    {"name":"Home", "lat":"40.714353", "lng":"-74.005973"},
    {"name":"San Francisco", "lat":"37.77493", "lng":"-122.419416"},
    {"name":"Nea Ionia", "lat":"38.0403338", "lng":"23.7588073"},
    {"name":"new ", "lat":formLong.toString, "lng":formLat.toString}  //,
...
function submitForm() {
    var formLong = document.forms.setHome.longitude.value;
    var formLat = document.forms.setHome.latitude.value;

    // Validate username and password
   // if (formLong === null || formLong === "") {
 ...
 //   }
    ...
    //    alert("The minimum length of longitude and latitude at least " + MINLENGTH);
   // }
  //  else {
...
function clearAndDisableForm(form) {   
    if (form == formType.LOGIN_FORM) { 
        // Clear the form       
        document.forms.login.longitude.value = '';
        document.forms.login.latitude.value = '';
        // Diabled the form
        document.forms.login.longitude.disabled = true;
        document.forms.login.latitude.disabled = true;
    }
}
